...
export default function DocsPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-overlay)] text-slate-300 font-sans selection:bg-cyan-500/30">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-xl font-black tracking-tight text-white">Loomo <span className="text-xs font-semibold px-2 py-0.5 rounded bg-slate-800 text-[var(--primary)] ml-1">Docs</span></span>
          </Link>
          ...
          <div className="flex items-center gap-6">
            <a 
              ...
              download 
              className="text-[var(--primary)] hover:text-white transition-colors flex items-center gap-1.5 font-semibold text-sm"
            >
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <button 
                    ...
                    className={`text-left w-full transition-colors ${activeSection === 'overview' ? 'text-[var(--primary)] font-bold' : 'text-slate-400 hover:text-white'}`}
                  >
                    Platform Overview
                  </button>
                </li>
                <li>
                  <button 
                    ...
                    className={`text-left w-full transition-colors ${activeSection === 'features' ? 'text-[var(--primary)] font-bold' : 'text-slate-400 hover:text-white'}`}
                  >
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <button 
                    ...
                    className={`text-left w-full transition-colors ${activeSection === 'step-1' ? 'text-[var(--primary)] font-bold' : 'text-slate-400 hover:text-white'}`}
                  >
                ...
                <li>
                  <button 
                    ...
                    className={`text-left w-full transition-colors ${activeSection === 'step-2' ? 'text-[var(--primary)] font-bold' : 'text-slate-400 hover:text-white'}`}
                  >
                ...
                <li>
                  <button 
                    ...
                    className={`text-left w-full transition-colors ${activeSection === 'step-3' ? 'text-[var(--primary)] font-bold' : 'text-slate-400 hover:text-white'}`}
                  >
                ...
                <li>
                  <button 
                    ...
                    className={`text-left w-full transition-colors ${activeSection === 'step-4' ? 'text-[var(--primary)] font-bold' : 'text-slate-400 hover:text-white'}`}
                  >
                    4. Annotate & Upload
                  </button>
                </li>
                <li>
                  <button 
                    ...
                    className={`text-left w-full transition-colors ${activeSection === 'step-5' ? 'text-[var(--primary)] font-bold' : 'text-slate-400 hover:text-white'}`}
                  >
        ...
        <main className="flex-1 max-w-3xl space-y-16">
          ...
          <section id="features" className="scroll-mt-28">
            ...
            <div className="prose prose-invert max-w-none text-slate-300 space-y-6">
              ...
              {/* Feature 1 */}
              <div className="border-l-2 border-[var(--primary)] pl-4 space-y-2">
              ...
              {/* Feature 2 */}
              <div className="border-l-2 border-[var(--secondary)] pl-4 space-y-2">
          ...
          <section id="step-1" className="scroll-mt-28 space-y-4">
            <div className="flex gap-4 items-center">
              <span className="text-xs bg-[var(--primary)]/20 text-[var(--primary)] px-2.5 py-1 rounded font-bold uppercase tracking-wider">Step 1</span>
            ...
            <div className="pl-0 space-y-3">
              ...
              <div className="bg-slate-950/40 p-5 rounded-xl border border-slate-850 space-y-2">
                <span className="text-xs font-bold text-[var(--secondary)] uppercase tracking-widest block">ℹ️ Access Permission Info</span>
                <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <section id="step-2" className="scroll-mt-28 space-y-4">
            <div className="flex gap-4 items-center">
              <span className="text-xs bg-[var(--secondary)]/20 text-[var(--secondary)] px-2.5 py-1 rounded font-bold uppercase tracking-wider">Step 2</span>
            ...
            <div className="pl-0 space-y-3">
              ...
              <div className="glass-panel p-6 rounded-xl border border-slate-850 space-y-3 bg-slate-900/10">
                ...
                <ol className="list-decimal list-inside space-y-2.5 text-xs text-slate-400 leading-relaxed">
                  <li>Download the compressed extension file by clicking the <a href="/loomo-extension.zip" download className="text-[var(--primary)] hover:underline font-bold">Download Extension</a> button at the top right of this page.</li>
            ...
            <div className="pl-0 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                <div className="bg-slate-950/30 p-5 rounded-xl border border-slate-850">
                  <h4 className="text-sm font-bold text-[var(--primary)] mb-2 flex items-center gap-1.5">
                ...
                <div className="bg-slate-950/30 p-5 rounded-xl border border-slate-850">
                  <h4 className="text-sm font-bold text-[var(--secondary)] mb-2 flex items-center gap-1.5">
          ...
          <section id="step-4" className="scroll-mt-28 space-y-4">
            <div className="flex gap-4 items-center">
              <span className="text-xs bg-[var(--primary)]/20 text-[var(--primary)] px-2.5 py-1 rounded font-bold uppercase tracking-wider">Step 4</span>
          ...
          <section id="step-5" className="scroll-mt-28 space-y-4">
            <div className="flex gap-4 items-center">
              <span className="text-xs bg-[var(--secondary)]/20 text-[var(--secondary)] px-2.5 py-1 rounded font-bold uppercase tracking-wider">Step 5</span>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-800/50 bg-[var(--bg-overlay)] py-8 text-center text-sm text-slate-500 relative z-10">
