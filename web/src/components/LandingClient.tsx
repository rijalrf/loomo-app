  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-slate-300 font-sans selection:bg-cyan-500/30">
      ...
      <main className="pt-36 pb-20 px-6 max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative">
        ...
        <div className="w-full lg:w-1/2 text-left z-10 relative flex flex-col justify-center">
          ...
          <h1 className="text-4xl md:text-6xl font-black leading-tight mb-6 tracking-tight text-white">
            Show, don&apos;t <br/>
            <span className="bg-gradient-to-r from-[#0CB2EB] to-[#8A5CF6] bg-clip-text text-transparent">just tell.</span>
          </h1>
          <p className="text-base md:text-lg text-slate-400 max-w-xl mb-8 leading-relaxed">
            The fastest way to capture your screen, add visual annotations, and share feedback instantly. 
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center relative mt-10 lg:mt-0 z-10">
          ...
          <div className="relative w-full max-w-lg glass-panel rounded-2xl border border-slate-700/60 shadow-2xl bg-[#1E293B]/60 p-1 overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:border-[#0CB2EB]/40">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800 bg-[#0F172A]/80">
              ...
              <span className="text-[10px] text-slate-500 font-mono">loomo-editor.html</span>
            ...
            <div className="relative bg-[#0F172A] aspect-[16/10] overflow-hidden flex items-center justify-center">
              ...
              <svg className="absolute top-1/4 left-1/3 translate-x-12 translate-y-3 w-16 h-8 text-red-500 drop-shadow-[0_0_5px_rgba(239,68,68,0.5)]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 100 50">
              ...
              <div className="absolute bottom-6 right-6 border border-[#0CB2EB] bg-[#0CB2EB]/20 px-3 py-1.5 rounded-lg text-[10px] text-white shadow-[0_0_15px_rgba(12,178,235,0.4)] flex items-center gap-2 animate-pulse">
                <svg className="w-3.5 h-3.5 text-[#0CB2EB]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-32 space-y-24 z-10 relative text-slate-300">
        ...
        {/* Bento Grid Features */}
        <section id="fungsi" className="scroll-mt-24">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-xl mx-auto text-sm leading-relaxed">
              Specially designed to speed up team coordination with a modern modular bento grid interface.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 glass-panel p-8 rounded-2xl border border-slate-800/80 bg-slate-900/40 relative overflow-hidden flex flex-col justify-between group hover:border-[#0CB2EB]/50 transition-all duration-300">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-white mb-2">Precision Area Capture & Annotations</h3>
                <p className="text-slate-400 text-sm leading-relaxed max-w-md">
                  Capture any area of the screen with a pixel-perfect crosshair, then add visual annotations like arrows, boxes, highlight markers, and text explanations instantly using our built-in image editor.
                </p>
              </div>
              <div className="mt-8 flex gap-2 overflow-hidden items-center border border-slate-850 p-2.5 bg-slate-950/40 rounded-lg max-w-sm">
                <span className="text-[10px] font-mono text-[#0CB2EB] bg-[#0CB2EB]/10 px-2 py-0.5 rounded">Editor</span>
                ...
                <span className="text-[10px] text-slate-500 font-mono overflow-hidden text-ellipsis whitespace-nowrap">Press &apos;Save&apos; to sync instantly</span>
              </div>
            </div>
            ...
            <div className="md:col-span-1 glass-panel p-8 rounded-2xl border border-slate-800/80 bg-slate-900/40 relative overflow-hidden flex flex-col justify-between group hover:border-[#8A5CF6]/50 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  100% stored in your personal Google Drive with secure, encrypted authorization. Absolute privacy under your full control.
                </p>
              </div>
              <div className="mt-8 border border-emerald-500/20 bg-emerald-500/5 p-3 rounded-xl flex items-center gap-2 w-fit">
                ...
                <span className="text-[10px] text-emerald-400 font-mono">100% Privacy Connected</span>
              </div>
            </div>
            ...
            <div className="md:col-span-1 glass-panel p-8 rounded-2xl border border-slate-800/80 bg-slate-900/40 relative overflow-hidden flex flex-col justify-between group hover:border-cyan-400/50 transition-all duration-300">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-white mb-2">Tab Video Recording</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Record screen activity directly from your browser tab in real-time, complete with microphone audio input without needing any desktop applications.
                </p>
              </div>
            ...
            <div className="md:col-span-2 glass-panel p-8 rounded-2xl border border-slate-800/80 bg-slate-900/40 relative overflow-hidden flex flex-col justify-between group hover:border-[#0CB2EB]/50 transition-all duration-300">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-white mb-2">Shareable Links & Workspace Collaboration</h3>
                <p className="text-slate-400 text-sm leading-relaxed max-w-md">
                  Generate short Loomo links (`loomo.app/s/token`) to share instantly without exposing your raw Google Drive links. Create shared workspaces for your team and manage file visibility centrally.
                </p>
              </div>
              <div className="mt-8 flex flex-wrap gap-2 items-center">
                <div className="border border-slate-800 bg-slate-950/50 px-3 py-1.5 rounded-lg text-[10px] font-mono text-slate-400 flex items-center gap-2">
                  ...
                  <button className="text-[#0CB2EB] hover:text-white font-bold">Copy</button>
                </div>
                <div className="flex -space-x-2">
                  <div className="w-6 h-6 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-[8px] font-bold text-white">R</div>
                  <div className="w-6 h-6 rounded-full bg-slate-700 border border-slate-700 flex items-center justify-center text-[8px] font-bold text-white">L</div>
                  <div className="w-6 h-6 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center text-[8px] font-bold text-slate-500">+3</div>
                </div>
              </div>
            </div>
